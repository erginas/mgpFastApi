...
class DurumKaydi(Base):
    __tablename__ = 'durum_kaydi'

    key: Mapped[Optional[String]] = mapped_column(String, nullable=False)
    ...
    kisi: Mapped[Optional['Kisi']] = relationship(back_populates='durum_kaydi')