...
class ReceteUretimTuketim(Base):
    __tablename__ = 'recete_uretim_tuketim'
    ...
    uretim_asamasi: Mapped[Optional['UretimAsamasi']] = relationship(back_populates='recete_uretim_tuketim')
    malzeme: Mapped[Optional['Malzeme']] = relationship(back_populates='recete_uretim_tuketim')
    malzeme_birimi: Mapped[Optional['MalzemeBirimi']] = relationship(back_populates='recete_uretim_tuketim')
    kisi: Mapped[Optional['Kisi']] = relationship(back_populates='recete_uretim_tuketim')