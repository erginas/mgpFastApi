...
class VeriTabaniSorgusu(Base):
    __tablename__ = 'veri_tabani_sorgusu'
    ...
    sorgu_vc: Mapped[Optional[String]] = mapped_column(String)
    sorgu: Mapped[Optional[String]] = mapped_column(String)
