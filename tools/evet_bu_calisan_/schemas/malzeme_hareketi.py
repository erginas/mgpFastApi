...
class MalzemeHareketiBase(BaseModel):
    ...
    bt_aciklama: Optional[String] = None
    ...
    mh_yil: Optional[Float] = None
    udi_humancode: Optional[String] = None

class MalzemeHareketiCreate(MalzemeHareketiBase):
    pass

class MalzemeHareketi(MalzemeHareketiBase):
    id: Optional[int]
