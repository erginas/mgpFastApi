...
class DepoSayimi202312Dkodu18Base(BaseModel):
...
class DepoSayimi202312Dkodu18Create(DepoSayimi202312Dkodu18Base):
    pass

class DepoSayimi202312Dkodu18(DepoSayimi202312Dkodu18Base):
    id: Optional[int]
